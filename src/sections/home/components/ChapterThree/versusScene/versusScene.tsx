...
import './versusScene.scss'; // อย่าลืม import ไฟล์ CSS
        ...
        <>
            <section className="bg-white" ref={main}>
                <div className="bg-versus ">
                    {/* bg */}
                    <img className="versus-abs" src='assets/background/chapter3/versus_bg/01.png' />
                    <img className="versus-abs" src='assets/background/chapter3/versus_bg/02.png' />
                    <img className="versus-abs" src='assets/background/chapter3/versus_bg/vs.png' />
                    {/* Character A */}
