...
export default function BookOpenScene({ onComplete }: Props) {
  ...
  return (
    ...
    >
      <div
        className="page w-[900px] max-w-full rounded-lg bg-cover p-12 shadow-2xl"
        style={{ backgroundImage: "url('/assets/ch1/book_open.png')" }}
      >
        <div className="page-text text-2xl leading-relaxed text-white">
