    ...
    useLayoutEffect(() => {
        const ctx = gsap.context(() => {
            ...
            idleTween
                ...
                .to('.hrk-magic-circle-1', { rotation: '+=360', duration: 15, ease: 'none', repeat: -1 }, 0)
                .to('.hrk-magic-circle-2', { rotation: '-=360', duration: 18, ease: 'none', repeat: -1 }, 0)
            ...
            tl.fromTo(magicBean, 
                ...
                { autoAlpha: 1, scale: 1, duration: 1, ease: 'power2.out' }, '+=0.5')
            ...
            attackTimeline.call(() => gsap.fromTo('.white-flash', { opacity: 0.8 }, { opacity: 0, duration: 0.2 }), null, 'startAttack+=2')
            ...
            }, 'startAttack+=2') // เริ่มพร้อมกระเด็น
            
            // 7. ซ่อนวงเวทย์ Haruki
            attackTimeline.to(['.hrk-magic-circle-1', '.hrk-magic-circle-2'], { 
                autoAlpha: 0, scale: 0, duration: 1 
            }, 'startAttack+=2') // เริ่มพร้อมกระเด็น

            // 8. Coffee Bean สลายตัว/หายไปหลังชน Haruki
            attackTimeline.to(magicBean, {
                autoAlpha: 0, scale: 0, duration: 0.5
            }, 'startAttack+=2.8') // 0.8s หลังชน Haruki

            tl.add(attackTimeline, 'startPhase3') // เพิ่ม attackTimeline เข้าไปใน Scroll Timeline หลัก


            // Phase 5: Victory Zoom Mild (คนชนะ)
            tl.to(bgRef.current, { scale: 1.8, xPercent: 10, yPercent:-35, transformOrigin: 'center center', duration: 3, ease: 'power2.inOut' }, '+=1')
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="haruki-container absolute top-[30%] left-[37%] z-20 h-[500px] w-[320px] md:h-[500px] md:w-[300px]">
                    <div className="relative h-full w-full">
                        <img src="/assets/part3/Character/Battle/Haruki/Pose/Haruki_arm_l.png" className="haruki-arm-l absolute left-0 top-[2%] z-10 w-full" alt="L Arm" />
                ...
                <div className="mild-gamer-container absolute bottom-[-20%] left-[30%] z-20 h-[500px] w-[320px] md:h-[750px] md:w-[450px]">
                    <div className="relative h-full w-full">
                        ...
                        <div className="mild-head-group absolute left-0 top-0 z-20 w-full">
                            <img src="/assets/part3/Character/Battle/Mild/Pose3/Mild_R_3_head.png" className="absolute left-0 top-0 w-full z-30" alt="Head Base" />
                ...
                <div className="magic-haruki-wrapper absolute top-[0%] right-[0%] z-10 pointer-events-none w-[700px] h-[700px]">
                    {/* วงเวทย์ (หมุนเองใน Idle) */}
                    <img
                        src="/assets/part3/Character/Battle/Haruki/Magic/Sun&moon_Circle.png"
                        className="hrk-magic-circle-1 absolute z-10 w-[200px] h-[200px] opacity-80 left-[-2%] top-[50%]"
                        alt="magic-circle-1"
                    />
                    <img
                        src="/assets/part3/Character/Battle/Haruki/Magic/Sun&moon_Circle.png"
                        className="hrk-magic-circle-2 absolute z-10 w-[200px] h-[200px] opacity-80 left-[18%] top-[50%]"
                        alt="magic-circle-2"
                    />
                ...
                <div className="mild-magic-back absolute bottom-[-5%] left-[19%] z-10 pointer-events-none">
            ...
            {/* Narration Boxes */}
            <div className="narration-box narration-final-1 absolute left-[20%] top-[20%] z-40 max-w-xl -translate-x-1/2 -translate-y-1/2 rotate-1 rounded-lg border-8 border-purple-900 bg-white/90 p-8 text-center shadow-2xl shadow-purple-900/50 opacity-0 will-change-transform">
            ...
            <div className="narration-box narration-final-2a absolute left-[20%] top-[20%] z-40 max-w-xl -translate-x-1/2 -translate-y-1/2 rotate-[-2deg] rounded-lg border-8 border-pink-700 bg-white/90 p-8 text-center shadow-2xl shadow-pink-900/50 opacity-0 will-change-transform">
                <p className="font-serif text-3xl font-bold leading-relaxed text-black md:text-3xl">
                    <span className="text-4xl text-pink-600 font-extrabold block mb-2">"MILD_R"</span>
