...
export default function CutSceneTwo({ onComplete }: Props) {
  ...
  const bgPath = cutSence.cutSence_2
  ...
  return (
    ...
    >
      ...
      <div
        ref={imageWrapperRef}
        className="aspect-video max-h-screen w-full opacity-0 will-change-transform"
        style={{
      ...
      <div className="absolute bottom-[10%] left-0 z-20 w-full px-4 text-center">
        <p
          ref={textRef}
          className="text-xl font-bold tracking-wide text-white opacity-0 drop-shadow-[0_4px_4px_rgba(0,0,0,0.8)] md:text-3xl"
        >
      ...
      <div className="absolute bottom-4 right-8 z-30 p-4 md:bottom-8 md:right-12">
        <h2
          ref={finTextRef}
          className="font-serif text-5xl font-bold italic tracking-wider text-yellow-500 opacity-0 drop-shadow-[0_2px_2px_rgba(0,0,0,0.8)] md:text-7xl"
        >
          End
        </h2>
      </div>
