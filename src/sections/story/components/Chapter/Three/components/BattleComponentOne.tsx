...
export default function BattleComponentOne() {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      const targets = [{ x: -700, y: 200 }, { x: -800, y: 0 }, { x: -700, y: -200 }];
      ...
      tl.set(bgRef.current, { scale: 2, xPercent: 25, yPercent: 25 })
        ...
        .fromTo('.narration-final-1',
          ...
          { autoAlpha: 1, scale: 1, rotation: 1, duration: 1.5, ease: 'back.out(1.7)' },
  ...
  return (
    <div ref={containerRef} className="relative h-screen w-full overflow-hidden bg-black">
      <div ref={bgRef} className="absolute inset-0 h-full w-full will-change-transform">
        ...
        {/* 2. Dr.Gamer */}
        <div className="dr-gamer-container absolute top-[25%] left-[7%] z-20 h-[500px] w-[320px] md:h-[750px] md:w-[500px]">
        ...
        {/* 5. Mild [Magic] */}
        <div className="absolute top-[15%] right-[0%] z-20 h-[1300px] w-[1300px] pointer-events-none">
          <div className="relative h-full w-full">
            <img src="/assets/part3/Character/Battle/Mild/Magic1/Fire_Circle.png" className="magic-mild-ice absolute right-[10%] top-[20%] z-10 w-[350px]" alt="Ice" />
            <img src="/assets/part3/Character/Battle/Mild/Magic1/Ice_Circle.png" className="magic-mild-sunmoon absolute right-[35%] top-[32%] z-10 w-[300px]" alt="SunMoon" />
            <img src="/assets/part3/Character/Battle/Mild/Magic1/Sun&moon_Circle.png" className="magic-mild-fire absolute right-[8%] bottom-[25%] z-10 w-[400px]" alt="Fire" />
          </div>
        </div>
