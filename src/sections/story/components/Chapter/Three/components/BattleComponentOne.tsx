  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* 2. Dr.Gamer */}
        <div className="dr-gamer-container absolute left-[7%] top-[25%] z-20 h-[500px] w-[320px] md:h-[750px] md:w-[500px]">
        ...
        <div className="absolute left-[0%] top-[15%] z-20 h-[1300px] w-[1300px]">
          <div className="relative h-full w-full">
            <img
              ...
              className="magic-dr-ciecle-l absolute left-[36%] top-[12%] z-10 w-[200px]"
              alt="L circle"
            />
            <div className="pointer-events-none absolute left-[4%] top-[3%] h-full w-full">
              <img
            ...
            <img
              src="/assets/part3/Character/Battle/Dr_Gamer/Magic/R_circle.png"
              className="magic-dr-ciecle-r absolute bottom-[35%] left-[6%] z-10 w-[300px]"
              alt="R circle"
            />
            <div className="pointer-events-none absolute bottom-[13%] left-[5%] h-full w-full">
              <img
        ...
        {/* 5. Mild [Magic] */}
        <div className="pointer-events-none absolute right-[0%] top-[15%] z-20 h-[1300px] w-[1300px]">
          <div className="relative h-full w-full">
            <img
              src="/assets/part3/Character/Battle/Mild/Magic1/Fire_Circle.png"
              className="magic-mild-ice absolute right-[10%] top-[20%] z-10 w-[350px]"
              alt="Ice"
            />
            <img
              src="/assets/part3/Character/Battle/Mild/Magic1/Ice_Circle.png"
              className="magic-mild-sunmoon absolute right-[35%] top-[32%] z-10 w-[300px]"
              alt="SunMoon"
            />
            <img
              src="/assets/part3/Character/Battle/Mild/Magic1/Sun&moon_Circle.png"
              className="magic-mild-fire absolute bottom-[25%] right-[8%] z-10 w-[400px]"
              alt="Fire"
            />
          </div>
        </div>
