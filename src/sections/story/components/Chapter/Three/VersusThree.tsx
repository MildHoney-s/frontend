...
export default function VersusThree() {
  return (
    <div id="chapter-three-versus-three">
      <VersusScene
        playerA={{
          name: 'Mild-R',
          alias: 'Mild-R สาวน้อย Introvert ',
          src: 'assets/Character/Versus/Mild-R/Mild_open.png',
        }}
        playerB={{
          name: 'Haruki',
          ...
          src: 'assets/Character/Versus/Haruki/Haruki_open.png',
        }}
      />
    </div>
  )
