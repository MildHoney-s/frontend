...
export default function HouseScene({ onComplete }: Props) {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.set('.mild-group', { autoAlpha: 1, transformOrigin: 'bottom center' })
      gsap.set('.mild-face-normal', { autoAlpha: 1 })
      gsap.set(['.mild-face-surprise', '.mild-face-happy'], { autoAlpha: 0 })
      gsap.set(['.mild-bubble-think', '.mild-bubble-speak'], { scale: 0, autoAlpha: 0, transformOrigin: 'bottom left' })
      ...
      tl.to('.text-mild-speak-1', { autoAlpha: 0, duration: 0.2, delay: 1.5 })
        .to('.mild-group', { y: -20, scaleY: 1.05, scaleX: 0.95, duration: 0.1, yoyo: true, repeat: 1, ease: 'power1.out' }, '<')
      ...
      tl.to('.line-1 .magic-char', { y: 0, autoAlpha: 1, duration: 0.05, stagger: 0.05, ease: 'power2.out' })
      tl.to('.line-2 .magic-char', { y: 0, autoAlpha: 1, duration: 0.05, stagger: 0.05, ease: 'power2.out' }, '>0.2')
      tl.to('.line-3 .magic-char', { y: 0, autoAlpha: 1, scale: 1.1, duration: 0.3, stagger: 0.08, ease: 'back.out(2)' }, '>0.2')
    ...
    >
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <img src={openDoorImg} className="h-full w-full object-cover" alt="bg" />
        </div>
        ...
        >
          <div className="mild-group relative bottom-0 h-full w-[90%]">
            <div className="mild-body-img relative h-full w-full">
              {/* Body Parts */}
              <img src="/assets/Part2/Mild/Body/Hair.PNG" className="absolute left-0 top-0 z-0 h-full w-full object-contain" alt="Back Hair" />
              <img src="/assets/Part2/Mild/Body/Body_1.PNG" className="absolute left-0 top-0 z-10 h-full w-full object-contain" alt="Body" />
        ...
        <div className="pointer-events-none absolute inset-0 z-20">
            <div className="h-full w-full bg-cover bg-center" style={{ backgroundImage: `url('${openDoorImg}')`, clipPath: 'polygon(0% 0%, 42.55% 0%, 42.55% 100%, 0% 100%)' }} />
        </div>

        {/* LAYER 3: DOOR PANEL */}
        <div ref={doorPanelRef} className="absolute inset-0 z-30">
          <img src={closedDoorImg} className="h-full w-full object-cover" alt="door" />
        ...
        <div className="honey-group absolute bottom-[0%] left-[45%] z-40 w-[25%]">
          <img src="/assets/Part2/Honey/Body.PNG" className="relative w-full drop-shadow-2xl" alt="Honey" />
          <img src="/assets/Part2/Honey/Normal_Face.PNG" className="absolute left-0 top-[1%] w-full" alt="Face" />
          ...
          <div className="honey-bubble-think absolute -right-[70%] -top-[50%] z-50 w-[130%] rounded-[2cqw] border-2 border-gray-200 bg-white p-[8%] shadow-xl">
            <p className="text-center text-[1.1cqw] font-bold leading-snug tracking-wider text-gray-700">
              "ใช่หลังนี้มั้ยนะ? <br /><span className="text-blue-500">ลองเคาะดูละกัน...</span>"
            </p>
        ...
        <div className="pointer-events-none absolute inset-0 z-50">
             ...
             <div className="mild-bubble-think absolute right-[35%] top-[30%] z-50 w-[12%] origin-bottom-left rounded-full border-2 border-gray-300 bg-white p-[1.5%] shadow-xl">
                <p className="text-center text-[1cqw] italic text-gray-500">"เอ๊ะ... <br /> ใครมาซะเย็นป่านนี้"</p>
             ...
             <div className="mild-bubble-speak absolute left-[40%] top-[35%] z-50 grid min-h-[12%] w-[18%] origin-bottom-left place-items-center rounded-[1.5cqw] border-2 border-pink-300 bg-pink-50 p-[1.5%] shadow-2xl">
                 <div className="text-mild-speak-1 absolute inset-0 flex items-center justify-center px-[5%] opacity-0">
                     <p className="text-center text-[1.1cqw] font-bold leading-snug tracking-wide text-gray-700">
                        <span className="mb-[2%] block text-[0.8cqw] font-medium tracking-wide text-gray-400">(เสียงเบา)</span>
                        "คะ... ใครหรอคะ..."
                     </p>
                 </div>
                 <div className="text-mild-speak-2 absolute inset-0 flex items-center justify-center px-[5%] opacity-0">
                    <p className="text-center text-[1.2cqw] font-bold leading-snug tracking-wide text-gray-800">
                        "เอ๊ะ!? คุณฮันนี่เองหรอ... <br /> <span className="mt-[2%] block text-[1cqw] tracking-wide text-gray-700">มีธุระอะไรรึป่าวคะ?"</span>
                    </p>
                 </div>
                 <div className="text-mild-speak-3 absolute inset-0 flex items-center justify-center px-[5%] opacity-0">
                    <p className="text-center text-[2cqw] font-bold tracking-wide text-gray-900">"จะ... จริงหรอคะ!?"</p>
                 </div>
  ...
  <div className="relative flex flex-col items-end space-y-[2%] p-[1%] text-right">
    ...
    <div className="magic-line-wrapper-1 overflow-hidden whitespace-nowrap">
      <p  className="text-xl font-bold leading-relaxed tracking-wider text-blue-200 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:text-3xl"style={{ WebkitTextStroke: '1px rgba(0,0,0,0.6)' }}>
        <SmartSplitText className="line-1">ขอโทษนะที่มารบกวน</SmartSplitText>
      </p>
    </div>
    ...
    <div className="magic-line-wrapper-2 overflow-hidden whitespace-nowrap">
      <p  className="text-xl font-bold leading-relaxed tracking-wider text-blue-200 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:text-3xl"style={{ WebkitTextStroke: '1px rgba(0,0,0,0.6)' }}>
        <SmartSplitText className="line-2">พอดีฉันตัดสินใจได้แล้วว่า</SmartSplitText>
      </p>
    </div>
    ...
    <div className="magic-line-wrapper-3 overflow-hidden whitespace-nowrap">
      <p  className="text-xl font-bold leading-relaxed tracking-wider text-blue-200 drop-shadow-[0_2px_4px_rgba(0,0,0,1)] md:text-3xl"style={{ WebkitTextStroke: '1px rgba(0,0,0,0.6)' }}>
        <SmartSplitText className="line-3">จะเป็นอาจารย์ให้เธอเอง!</SmartSplitText>
      </p>
    </div>
